...
Now that we have our datasets, we can load them and join them as a single dataset using the 'day' value. We can inspect some rows of our dataset using the *head()* method of Pandas.
