...
Seems pretty unreasonable to me that we could have over 40° in December, so it's pretty safe to assume there must be some error on the data which may hurt our prediciton. I'll proceed by removing those data and using a null value as a placeholder. 
