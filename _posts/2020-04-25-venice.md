...
I also want to state that all the data used in this project is for educational purpose and it's no-profit in any means, as stated in the Terms of use of such data.
